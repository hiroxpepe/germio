...
#nullable enable
        ...
        public static DataRoot? Load(string? basePath = null)
        {
            ...
            if (File.Exists(pathJson))
            {
                ...
                return JsonConvert.DeserializeObject<DataRoot>(json)!;
            }
        ...
        public static void Save(DataRoot data, bool encrypt = false, string? basePath = null)
        {
            string dir = basePath ?? Directory.GetCurrentDirectory();
            string pathJson = Path.Combine(dir, JSON_PATH);
            string pathEnc = Path.Combine(dir, ENC_PATH);
