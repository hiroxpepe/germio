...
Extra code words, past basic_words.md, from a real, named, open list:
the New General Service List (NGSL) 1.2. Free to use, with credit
given, under its own Creative Commons Attribution ShareAlike 4.0
license. Made by three people; see the real, current web place for
the list itself, and for their own full names.

This file is frozen once put in place, the same as basic_words.md.
...
+ bear bearing bears bore borne
+ beat beated beating beats
+ beauty beauties
+ become becomed becomes becoming
+ bedroom bedrooms
+ beer beers
...
+ castle castles
+ catalog cataloged cataloging catalogs
...
+ clinical
+ close closed closer closes closest closing
+ closely
+ clothes clothesed clotheses clothesing
+ clothing clothinged clothinging clothings
...
+ compute computed computes computing
+ computer computers
...
+ district districted districting districts
...
+ ease eased eases easing
+ easily
+ eastern
+ easy easier easiest
+ eat eated eating eats
+ economic
+ economy economies
...
+ else
+ elsewhere
+ email emailed emailing emails
+ embarrass embarrassed embarrasses embarrassing
...
+ evening eveninged eveninging evenings
+ eventually
+ everybody
+ everyday
+ everyone
...
+ formal
+ format formated formating formats
...
+ fuel fueled fueling fuels
+ fulfill fulfilled fulfilling fulfills
+ fully
+ fun funs
+ function functions
+ functional
...
+ league leagues
+ lean leaned leaner leanest leaning leans
+ leap leaping leaps leapt
+ learn learning learns learnt
+ least
...
+ matter matters
+ mature matured matures maturing
+ maximum maximums
+ maybe
+ mayor mayors
+ mean meaned meaning means
+ meanwhile
...
+ mission missions
+ mistake mistaked mistakes mistaking
+ mixture mixtures
+ mobile mobiles
+ mode modes
...
+ proceed proceeded proceeding proceeds
+ producer producers
+ product products
...
+ reform reformed reforming reforms
+ refugee refugees
...
+ risk risks
+ rival rivaled rivaling rivals
+ rock rocks
+ role roles
+ romantic romantics
+ rose rosed roses rosing
+ roughly
...
+ segment segmented segmenting segments
+ select
...
+ session sessions
+ set sets setting
+ settle settled settles settling
...
+ string stringing strings strung
...
+ underlie underlied underlies underliing
+ understand understanding understands understood
+ undertake undertaked undertakes undertaking
+ unemployment
+ unfortunately
+ uniform
+ union unions
